...
if [ -f ./_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/emconfig.json ]; then
    cp ./_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/emconfig.json .
fi
...
# Run the benchmark
if [ -f ./${TEST_EXEC} ]; then
    ./${TEST_EXEC} -x build_dir.hw.xilinx_u280_gen3x16_xdma_1_202211_1/chiimg_benchmark.xclbin
else
