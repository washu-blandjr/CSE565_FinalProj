...
if [ -f ./_x.hw_emu.xilinx_u280_gen3x16_xdma_1_202211_1/emconfig.json ]; then
...
# Run the benchmark
if [ -f ./${TEST_EXEC} ]; then
    ./${TEST_EXEC} -x build_dir.hw_emu.xilinx_u280_gen3x16_xdma_1_202211_1/chiimg_benchmark.xclbin
else
